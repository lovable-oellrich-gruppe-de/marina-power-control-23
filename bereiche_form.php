...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($bereich['name'])) {
        ...
        if (!empty($bereich['id'])) {
            ...
            header("Location: bereiche.php?success=" . urlencode("Bereich wurde erfolgreich aktualisiert."));
            exit;
        } else {
            // Neu anlegen
            ...
            header("Location: bereiche.php?success=" . urlencode("Bereich wurde erfolgreich erstellt."));
            exit;
        }
    }
}
