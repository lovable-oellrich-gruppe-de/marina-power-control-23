            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <nav class="ml-6 flex space-x-4 items-center">
                        ...
                        <a href="zaehler_verbrauchhaupt.php" class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-marina-700 hover:bg-gray-50">Hauptzählerverbrauch</a>
                ...
                <div class="flex items-center space-x-4">
                    <div class="text-sm text-gray-700 flex flex-col items-start leading-tight">
                        ...
                        <a href="passwort_zuruecksetzen.php" class="text-xs text-marina-600 hover:underline">
                            Passwort ändern
                        </a>
                    </div>
                    <div>
